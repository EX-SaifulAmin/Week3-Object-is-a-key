...
function countProfit(shoppers) {
  ...
  if(shoppers[u].product == listBarang[i][0] && sisaStock>= shoppers[u].amount) {
  dataX.push(shoppers[u].name)
  sisaStock -= shoppers[u].amount
  }
}
  purchased.product = listBarang[i][0]
  purchased.shoppers = dataX
  purchased.leftOver = sisaStock
  purchased.totalProfit = (listBarang[i][2] - sisaStock)*listBarang[i][1]
  data.push(purchased)
  purchased ={}
}
  return data
